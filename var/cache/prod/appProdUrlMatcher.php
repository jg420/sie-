...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/direction/direction-defaut') {
        ...
        if (0 === strpos($pathinfo, '/equipement')) {
            ...
            if ($pathinfo === '/equipement/addEquipement') {
                ...
                return array (  '_controller' => 'SIE\\EquipementBundle\\Controller\\AdminController::getEquipementAction',  '_route' => 'add_equipement',);
            }
            not_add_equipement:
        ...
        if (0 === strpos($pathinfo, '/api')) {
            // api_get_central
            if (0 === strpos($pathinfo, '/api/centrals') && preg_match('#^/api/centrals/(?P<id>[^/\\.]++)(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_get_central;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_get_central')), array (  '_controller' => 'SIE\\CentralBundle\\Controller\\CentralRestController::getCentralAction',  '_format' => 'json',));
            }
            not_api_get_central:

            // api_get_equipement
            if (0 === strpos($pathinfo, '/api/equipements') && preg_match('#^/api/equipements/(?P<username>[^/\\.]++)(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_get_equipement;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_get_equipement')), array (  '_controller' => 'SIE\\EquipementBundle\\Controller\\EquipementRestController::getEquipementAction',  '_format' => 'json',));
            }
            not_api_get_equipement:

            // api_get_contrat
            if (0 === strpos($pathinfo, '/api/contrats') && preg_match('#^/api/contrats/(?P<username>[^/\\.]++)(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_get_contrat;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_get_contrat')), array (  '_controller' => 'SIE\\ContratBundle\\Controller\\ContratRestController::getContratAction',  '_format' => 'json',));
            }
            not_api_get_contrat:

            // api_get_access
            if (0 === strpos($pathinfo, '/api/accesses') && preg_match('#^/api/accesses/(?P<username>[^/\\.]++)(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_get_access;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_get_access')), array (  '_controller' => 'SIE\\AccessBundle\\Controller\\AccessRestController::getAccessAction',  '_format' => 'json',));
            }
            not_api_get_access:
