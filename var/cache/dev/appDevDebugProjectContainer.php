...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'referentiel', 'user' => 'root', 'password' => 'bob123', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_347a6e0f91ecd305ab3e03fd23cca6fecbc0e6be023bf93ff0fac309a9c067d2');
    ...
    {
        return $this->services['sie_access.datamanager'] = new \SIE\AccessBundle\DataManager\MySql('127.0.0.1', 'root', 'bob123', 'referentiel');
    }
    ...
    {
        return $this->services['sie_central.datamanager'] = new \SIE\CentralBundle\DataManager\MySql('127.0.0.1', 'root', 'bob123', 'referentiel');
    }
    ...
    {
        return $this->services['sie_equipement.datamanager'] = new \SIE\EquipementBundle\DataManager\MySql('127.0.0.1', 'root', 'bob123', 'referentiel');
    }
