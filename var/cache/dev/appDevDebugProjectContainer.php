...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIECentralBundle', ($this->targetDirs[3].'\\app/Resources/SIECentralBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIECentralBundle', ($this->targetDirs[3].'\\src\\SIE\\CentralBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEEquipementBundle', ($this->targetDirs[3].'\\app/Resources/SIEEquipementBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEEquipementBundle', ($this->targetDirs[3].'\\src\\SIE\\EquipementBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEDirectionBundle', ($this->targetDirs[3].'\\app/Resources/SIEDirectionBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEDirectionBundle', ($this->targetDirs[3].'\\src\\SIE\\DirectionBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIECoreBundle', ($this->targetDirs[3].'\\app/Resources/SIECoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIECoreBundle', ($this->targetDirs[3].'\\src\\SIE\\CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEAccessBundle', ($this->targetDirs[3].'\\app/Resources/SIEAccessBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEAccessBundle', ($this->targetDirs[3].'\\src\\SIE\\AccessBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEContratBundle', ($this->targetDirs[3].'\\app/Resources/SIEContratBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEContratBundle', ($this->targetDirs[3].'\\src\\SIE\\ContratBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEDocumentBundle', ($this->targetDirs[3].'\\app/Resources/SIEDocumentBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SIEDocumentBundle', ($this->targetDirs[3].'\\src\\SIE\\DocumentBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'referenciel', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\SIE\\CoreBundle\\Resources\\config\\doctrine') => 'SIE\\CoreBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'SIE\\CoreBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SIECoreBundle' => 'SIE\\CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d3740f2a5ca0429b0b0de7f47ebffe817bd9634e07c4580f882b8bd406572413');
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle/Resources/config/serializer'), 'SIE\\CentralBundle' => ($this->targetDirs[3].'\\src\\SIE\\CentralBundle/Resources/config/serializer'), 'SIE\\EquipementBundle' => ($this->targetDirs[3].'\\src\\SIE\\EquipementBundle/Resources/config/serializer'), 'SIE\\DirectionBundle' => ($this->targetDirs[3].'\\src\\SIE\\DirectionBundle/Resources/config/serializer'), 'SIE\\CoreBundle' => ($this->targetDirs[3].'\\src\\SIE\\CoreBundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'SIE\\AccessBundle' => ($this->targetDirs[3].'\\src\\SIE\\AccessBundle/Resources/config/serializer'), 'SIE\\ContratBundle' => ($this->targetDirs[3].'\\src\\SIE\\ContratBundle/Resources/config/serializer'), 'SIE\\DocumentBundle' => ($this->targetDirs[3].'\\src\\SIE\\DocumentBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['sie_access.datamanager'] = new \SIE\AccessBundle\DataManager\MySql('127.0.0.1', 'root', '', 'referenciel');
    }
    ...
    {
        return $this->services['sie_central.datamanager'] = new \SIE\CentralBundle\DataManager\MySql('127.0.0.1', 'root', '', 'referenciel');
    }
    ...
    {
        return $this->services['sie_contrat.datamanager'] = new \SIE\ContratBundle\DataManager\MySql('127.0.0.1', 'root', '', 'referenciel');
    }
    ...
    {
        return $this->services['sie_document.datamanager'] = new \SIE\DocumentBundle\DataManager\MySql('127.0.0.1', 'root', '', 'referenciel');
    }
    ...
    {
        return $this->services['sie_equipement.datamanager'] = new \SIE\EquipementBundle\DataManager\MySql('127.0.0.1', 'root', '', 'referenciel');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'SIECentralBundle', 8 => 'SIEEquipementBundle', 9 => 'SIEDirectionBundle', 10 => 'SIECoreBundle', 11 => 'AsseticBundle', 12 => 'JMSSerializerBundle', 13 => 'SIEAccessBundle', 14 => 'SIEContratBundle', 15 => 'SIEDocumentBundle', 16 => 'DebugBundle', 17 => 'WebProfilerBundle', 18 => 'SensioDistributionBundle', 19 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\CentralBundle/Resources/views'), 'SIECentral');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\EquipementBundle/Resources/views'), 'SIEEquipement');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\DirectionBundle/Resources/views'), 'SIEDirection');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\CoreBundle/Resources/views'), 'SIECore');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\AccessBundle/Resources/views'), 'SIEAccess');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\ContratBundle/Resources/views'), 'SIEContrat');
        $instance->addPath(($this->targetDirs[3].'\\src\\SIE\\DocumentBundle/Resources/views'), 'SIEDocument');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('712822bc479752aad8c012191f7fc6cd46556c6a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57e54472725cd1.98458337')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SIECentralBundle' => 'SIE\\CentralBundle\\SIECentralBundle',
                'SIEEquipementBundle' => 'SIE\\EquipementBundle\\SIEEquipementBundle',
                'SIEDirectionBundle' => 'SIE\\DirectionBundle\\SIEDirectionBundle',
                'SIECoreBundle' => 'SIE\\CoreBundle\\SIECoreBundle',
                'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'SIEAccessBundle' => 'SIE\\AccessBundle\\SIEAccessBundle',
                'SIEContratBundle' => 'SIE\\ContratBundle\\SIEContratBundle',
                'SIEDocumentBundle' => 'SIE\\DocumentBundle\\SIEDocumentBundle',
            ...
            'uploaded_file_path' => 'C:/wamp/www/ref_com_sie/web/uploads/',
            'host' => '127.0.0.1',
            'login' => 'root',
            'mdp' => '',
            'bdd' => 'referenciel',
            ...
            'kernel.secret' => '712822bc479752aad8c012191f7fc6cd46556c6a',
            ...
            'assetic.bundles' => array(
                ...
                7 => 'SIECentralBundle',
                8 => 'SIEEquipementBundle',
                9 => 'SIEDirectionBundle',
                10 => 'SIECoreBundle',
                11 => 'AsseticBundle',
                12 => 'JMSSerializerBundle',
                13 => 'SIEAccessBundle',
                14 => 'SIEContratBundle',
                15 => 'SIEDocumentBundle',
                16 => 'DebugBundle',
