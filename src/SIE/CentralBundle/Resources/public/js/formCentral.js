//SIE/CentralBundle/Resources/public/js
...
$(document).ready(function () {
    ...
    $('#btn_modif_central').click(function () {
        if ($('#output_id_central').val() !== "") {
            ...
            $('#btn_valid_modif_central').attr('style', 'visibility:visible');
            $('#btn_annuler_modif_central').attr('style', 'visibility:visible');
    ...
    $('#btn_annuler_modif_central').click(function () {
        ...
        $('#btn_modif_central').attr('style', 'visibility:visible');
        $('#btn_valid_modif_central').attr('style', 'visibility:hidden');
        $('#btn_annuler_modif_central').attr('style', 'visibility:hidden');
